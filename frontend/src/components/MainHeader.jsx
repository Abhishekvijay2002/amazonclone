...
<div>
  ...
  <div className="flex items-center ml-7 gap-5">
    ...
    <div className="flex flex-col text-xs leading-tight">
      <span className="text-gray-400 pl-6 text-base">Delivering to Surat 394210</span>
...
<AccountMegaMenu/>
    ...
    {/* Orders */}
    <div className="flex flex-col text-xl  leading-tight mx-3">
      <span>Returns</span>
    ...
    <img src="./cart.png" className="w-15 h-15"/> Cart
    </div>
    </div></div>
